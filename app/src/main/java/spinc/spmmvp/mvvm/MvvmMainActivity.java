...
import spinc.spmmvp.databinding.MvvmMainActivityBinding;
...
public class MvvmMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MvvmMainActivityBinding binding = DataBindingUtil.setContentView(this, R.layout.mvvm_main_activity);
